...
namespace NetSMOKE{
	...
	Units_Reactors_PSR_NonIsothermal::Units_Reactors_PSR_NonIsothermal(OpenSMOKE::ThermodynamicsMap_CHEMKIN *thermodynamicsMapXML, OpenSMOKE::KineticsMap_CHEMKIN *kineticsMapXML, NetSMOKE::UnitInfo unit_data) :
	...
	int Units_Reactors_PSR_NonIsothermal::Solve(std::vector<NetSMOKE::StreamInfo> &streams_data_structure) {
	...
	/* Get Residuals */
	int Units_Reactors_PSR_NonIsothermal::GetResiduals(OpenSMOKE::OpenSMOKEVectorDouble &residuals, std::vector<NetSMOKE::StreamInfo> &streams_data_structure){
	...
	/* Solve sequentially */
	int Units_Reactors_PSR_NonIsothermal::NonIterativeSolve(std::vector<NetSMOKE::StreamInfo> &streams_data_structure)
	{
	...
	/* Solve for RTD */
	int Units_Reactors_PSR_NonIsothermal::RTD(OpenSMOKE::OpenSMOKEVectorDouble &residuals, const double t, std::vector<NetSMOKE::StreamInfo> &streams_data_structure) {
		Units_Reactors_PSR_NonIsothermal::GetResiduals(residuals, streams_data_structure);
		return 0;
	}

	/* Print reactor status */
	void Units_Reactors_PSR_NonIsothermal::PrintStatus(boost::filesystem::path output_folder, std::vector<NetSMOKE::StreamInfo> &streams_data_structure){
