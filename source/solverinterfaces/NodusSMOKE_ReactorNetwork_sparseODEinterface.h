...
#ifndef NODUSSMOKE_REACTORNETWORK_SPARSEODEINTERFACE_H
#define NODUSSMOKE_REACTORNETWORK_SPARSEODEINTERFACE_H

#include "ReactorNetwork.h"

// ODE Solver
#include "math/native-ode-solvers/MultiValueSolver"
#include "NodusSMOKE_ReactorNetwork_sparseODEinterface.h"

class NodusSMOKE_ReactorNetwork_sparseODEinterface
{
public:

	NodusSMOKE_ReactorNetwork_sparseODEinterface() {};
...
#endif /* NODUSSMOKE_REACTORNETWORK_SPARSEODEINTERFACE_H */