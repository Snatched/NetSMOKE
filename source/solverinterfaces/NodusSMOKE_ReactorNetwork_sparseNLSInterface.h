...
#ifndef NODUSSMOKE_REACTORNETWORK_SPARSENLSINTERFACE_H
#define NODUSSMOKE_REACTORNETWORK_SPARSENLSINTERFACE_H

#include "ReactorNetwork.h"

// NLS Solver
#include "math/native-nls-solvers/NonLinearSystemSolver"
#include "NodusSMOKE_ReactorNetwork_sparseNLSinterface.h"


class NodusSMOKE_ReactorNetwork_sparseNLSinterface
{
public:

	NodusSMOKE_ReactorNetwork_sparseNLSinterface() {};
...
#endif /* NODUSSMOKE_REACTORNETWORK_sparseNLSINTERFACE_H */
