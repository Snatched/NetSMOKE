	...
	*/
	...
	public:
		...
		*/
		...
		void GetFinalResults(OpenSMOKE::OpenSMOKEVectorDouble &final_omega, OpenSMOKE::OpenSMOKEVectorDouble &final_formation_rates, double &rho_mix, double &outletT, double &Vol, double &Hout, double &Qr, double &Qe, double &CPmix);

		// void GetFinalResults(OpenSMOKE::OpenSMOKEVectorDouble &final_omega, OpenSMOKE::OpenSMOKEVectorDouble &final_formation_rates, double &rho_mix, double &outletT);
