...
namespace OpenSMOKE
{
	...
	PlugFlowReactor_NonIsothermal::PlugFlowReactor_NonIsothermal(	
		...
		PlugFlowReactor(thermodynamicsMap, kineticsMap, ode_parameters, plugflow_options, on_the_fly_ropa, on_the_fly_post_processing, polimi_soot_analyzer)
	{
	...
	void PlugFlowReactor_NonIsothermal::GetFinalResults(OpenSMOKE::OpenSMOKEVectorDouble &final_omega, OpenSMOKE::OpenSMOKEVectorDouble &final_formation_rates,double &rho_mix, double &outletT){
	final_omega.CopyFrom(omega_.GetHandle());
	final_formation_rates.CopyFrom(R_.GetHandle());
	rho_mix = rho_;
	outletT = T_;
	}
}
