...
namespace OpenSMOKE
{
	...
	void PerfectlyStirredReactor_NonIsothermal_ConstantPressure::GetFinalResults(OpenSMOKE::OpenSMOKEVectorDouble &final_omega, OpenSMOKE::OpenSMOKEVectorDouble &final_formation_rates,double &rho_mix, double &outletT, double &Vol, double &Hout, double &Qr, double &Qe, double &CPmix)
	{

		final_omega.CopyFrom(omega_.GetHandle());	//!< current mass fractions
		final_formation_rates.CopyFrom(R_.GetHandle());		//!< current formation rates [kmol/m3/s]
		rho_mix = rho_;		//!< density of the mixture inside the reactor
		outletT = T_;
	...
	/*
	void PerfectlyStirredReactor_NonIsothermal_ConstantPressure::GetFinalResults(OpenSMOKE::OpenSMOKEVectorDouble &final_omega, OpenSMOKE::OpenSMOKEVectorDouble &final_formation_rates, double &rho_mix, double &outletT)
	{
