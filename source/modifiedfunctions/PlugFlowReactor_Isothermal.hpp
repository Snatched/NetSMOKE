...
namespace OpenSMOKE
{
	...
	void PlugFlowReactor_Isothermal::GetFinalResults(OpenSMOKE::OpenSMOKEVectorDouble &final_omega, OpenSMOKE::OpenSMOKEVectorDouble &final_formation_rates,double &rho_mix){
