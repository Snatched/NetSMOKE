...
namespace OpenSMOKE
{
	...
	void PerfectlyStirredReactor_Isothermal_ConstantPressure::GetFinalResults(OpenSMOKE::OpenSMOKEVectorDouble &final_omega, OpenSMOKE::OpenSMOKEVectorDouble &final_formation_rates,double &rho_mix)
	{
