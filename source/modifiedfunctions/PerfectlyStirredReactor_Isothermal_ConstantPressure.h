...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*@param rho_mix empty double to fill with rho of the mixture
		*@param tau empty double to fill with residence time
		*/
		void GetFinalResults(OpenSMOKE::OpenSMOKEVectorDouble &final_omega, OpenSMOKE::OpenSMOKEVectorDouble &final_formation_rates,double &rho_mix);
